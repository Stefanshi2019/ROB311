...
def test1(create_graph=False) -> int:
    ...
    if r_100 < 0.8 or r_200 < 0.8:
        points += 0
    elif r_100 < 0.9 or r_200 < 0.9:
        points += 1
    elif r_100 < 0.95 or r_200 < 0.95:
        points += 2
    else:
        points += 3
...
if __name__ == '__main__':
    ...
    ten = 0
    for i in range(20):
        test = test1(create_graph=False)
        if test == 10:
            ten += 1
        sum += test
    print("You have scored {}/10 in part 1".format(sum / 20))
    print("You have scored {} 10/10 in part 1".format(ten))
